 ...
 *
 *
 * @ORM\Table(name="ReservationDemande")
 * @ORM\Entity
 */
class ReservationDemande
{
    /**
     * @var integer
     *
     ...
     * @ORM\ManyToOne(targetEntity="MyApp\UserBundle\Entity\User")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="idbenificiaire", referencedColumnName="id",onDelete="CASCADE")
     * })
     */

    private $idbenificiaire;

    /**
     * @return \User
     */
    public function getIdbenificiaire()
    {
        return $this->idbenificiaire;
    }

    /**
     * @param \User $idbenificiaire
     */
    public function setIdbenificiaire($idbenificiaire)
    {
